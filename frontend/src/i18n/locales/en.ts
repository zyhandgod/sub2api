export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportDropTitle: 'Drop JSON files or folders here',
      dataImportDropHint: 'Supports multiple files and dragged folders, recursively importing .json files inside.',
      dataImportMergedFromFiles: 'Merged {count} JSON files into 1 import file.',
      ...
      dataImportMixedTypes: 'Do not mix Codex files with Sub2API backup files. Import them separately.',

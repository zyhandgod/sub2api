export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportFile: '数据文件',
      dataImportDropTitle: '拖拽 JSON 文件或文件夹到这里',
      dataImportDropHint: '支持多选文件，也支持拖拽文件夹后递归导入其中的 .json 文件。',
      dataImportMergedFromFiles: '已将 {count} 个 JSON 文件合并为 1 个导入文件。',
      dataImportButton: '开始导入',
      dataImporting: '导入中...',
      dataImportSelectFile: '请选择数据文件',
      dataImportParseFailed: '数据解析失败',
      dataImportMixedTypes: '请不要混合导入 Codex 文件和 Sub2API 备份文件，请分开导入。',
